...
```{r echo = F, cache = T, fig.cap = "Treemap luchthaven en maatschappij.", fig.show = "hold", warning = F}
...
```{r echo = F, cache = T, fig.cap = "Mosaic plot luchthaven en maatschappij.", fig.show = "hold"}
data_f %>%
    ggplot() +
